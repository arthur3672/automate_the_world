	...
	if os.path.isdir(args.n):
		...
		for filename in os.listdir(args.n):
			if filename.endswith('.nessus'):
				...
				va_raw_to_xlsx.main(fullpath_file, mid_xlsx_file)
	else:
		if args.n.endswith('.nessus'):
			va_raw_to_xlsx.main(args.n, mid_xlsx_file)
		else:
			parser.print_usage()
			exit()
	...
	if os.path.isdir(args.x):
		...
		for filename in os.listdir(args.x):
			if filename.endswith('.xml'):
				...
				va_nmap.main(fullpath_file, output_file)
	else:
		if args.x.endswith('.xml'):
			va_nmap.main(args.x, output_file)
		else:
			parser.print_usage()
			exit()
